...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Return Orders Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">Return Orders Report</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-striped dataTable dtr-inline" id="ReturnReport_Table">
                        <thead>
                            <th>Return Id</th>
                            <th>Purchase Date</th>
                            <th>Return Date</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from = '',to ='')
            {
                ...
                var table = $('#ReturnReport_Table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:"{{ route('ReturnOrdersReport.index') }}",
                    ...
                    columns : [
                        ...
                        {data: 'Amount_Returned', name: 'Amount_Returned'},
                        {data: 'Return_Method', name: 'Return_Method'},
                    ],
                    // order: [ [0, 'desc'] ]
                });
                ...
                $('#Cust_Name').keyup(function(){
                    ...
                    // console.log(custFil);
                    table.column(4).search(custFil).draw();
                });    

                $('#Cust_Contact').keyup(function(){
                    var contFil = $(this).val();
                    // console.log(contFil);
                    table.column(5).search(contFil).draw();
                });

                $('#Payment_Method').keyup(function(){
                    var payFil = $(this).val();
                    // console.log(contFil);
                    table.column(8).search(payFil).draw();
                });
            }
