            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Payment Report</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="PaymentReport_Table">
                        <thead>
                            <th>id</th>
                            <th>Date</th>
                            <th>Customer Name</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from = '',to ='')
            {
                ...
                var table = $('#PaymentReport_Table').DataTable({
            ...
            $('#filter').click(function(){
                ...
                if(f !='' && t!='')
                {
                    $('#PaymentReport_Table').DataTable().clear().destroy();
                    load_data(f,t);
                }
                else
                {
