...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">PayBack Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">PayBack Report</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="PayBackReport_Table">
                        <thead>
                            <th>id</th>
                            <th>Date</th>
                            <th>Customer Name</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from = '',to ='')
            {
                ...
                var table = $('#PayBackReport_Table').DataTable({
            ...
            $('#filter').click(function(){
                ...
                if(f !='' && t!='')
                {
                    $('#PayBackReport_Table').DataTable().clear().destroy();
                    load_data(f,t);
                }
                else
                {
