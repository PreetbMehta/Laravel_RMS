    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <input type="text" name="Supplier_Name" id="Supplier_Name" class="form-control col-md-5 m-1" placeholder="Supplier Name">
                    <input type="text" name="Brand_Name" id="Brand_Name" class="form-control col-md-5 m-1" placeholder="Brand Name">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable dtr-inline collapsed" id="PurchaseReport_Table">
                        <thead>
                            <th>Purchase Id</th>
                            <th>Date</th>
                            <th>Supplier Name</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from = '',to ='')
            {
                ...
                var table = $('#PurchaseReport_Table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:"{{ route('purchaseReport.index') }}",
            ...
            $('#filter').click(function(){
                ...
                if(f !='' && t!='')
                {
                    $('#PurchaseReport_Table').DataTable().clear().destroy();
                    load_data(f,t);
                }
                else
                {
